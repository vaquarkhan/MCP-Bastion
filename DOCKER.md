...
**Current release pin:** Dockerfiles use `ARG BASTION_VERSION=2.0.2`, which installs `mcp-bastion-python==2.0.2` inside proxy and dashboard images at build time.
...
**Current release:** **2.0.2** (2026-07-05) - `pip install mcp-bastion-python==2.0.2`
