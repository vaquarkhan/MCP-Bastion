...
**Current release pin:** Dockerfiles use `ARG BASTION_VERSION=3.0.0`, which installs `mcp-bastion-python==3.0.0` inside proxy and dashboard images at build time.
...
**Current release:** **3.0.0** (2026-07-11) - `pip install mcp-bastion-python==3.0.0`
