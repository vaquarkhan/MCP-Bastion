...
| **Third-party / vendor MCP you cannot fork** | **Proxy or wrapper:** a process that accepts MCP from clients, runs messages through Bastion, then forwards to the upstream server. You own that hop. | Integration pattern you design; see [TUTORIALS.md](TUTORIALS.md) (Tutorial 3, Option B). |
