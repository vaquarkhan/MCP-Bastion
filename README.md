...
[![PyPI version](https://img.shields.io/pypi/v/mcp-bastion-python.svg?label=PyPI&logo=pypi&logoColor=white)](https://pypi.org/project/mcp-bastion-python/4.0.1/)
...
**Current release: [4.0.1](https://pypi.org/project/mcp-bastion-python/4.0.1/)** · Docker `v4.0.0` · 18 PyPI packages · [CHANGELOG](CHANGELOG.md)
...
<p align="center">
  <img
    src="images/mcp-bastion-scan-test-enforce.svg"
...
### Runtime governance pillars (3.0.0+, current **4.0.1**)
...
<p align="center">
  <img
    src="images/mcp-bastion-runtime-governance.svg"
...
pip install mcp-bastion-python==4.0.1
```
